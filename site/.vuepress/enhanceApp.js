export default ({ router }) => {
  router.addRoutes([
    ...
    { path: '/5-permasalahan-yang-membingungkan-bagi-css-newbie', redirect: '/permasalahan-yang-membingungkan-bagi-css-newbie/' },
    { path: '/30-software-gratis-terbaik', redirect: '/software-gratis-terbaik/' },
    { path: '/3-tips-agar-desain-anda-menarik', redirect: '/tips-agar-desain-anda-menarik/' },
    { path: '/10-website-sumber-inspirasi-desain', redirect: '/website-sumber-inspirasi-desain/' },
