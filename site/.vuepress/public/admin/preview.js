...
const html = htm.bind(h); // customize markdown-it
...
let options = {
  ...
  highlight: function (str, lang) {
    ...
    if (prismCore.languages[lang]) {
      return '<pre class="language-' + lang + '"><code class="language-' + lang + '">' + prismCore.highlight(str, prismCore.languages[lang], lang) + '</code></pre>';
    } else {
      return '<pre class="language-' + lang + '"><code class="language-' + lang + '">' + prismCore.util.encode(str) + '</code></pre>';
    }
  }
};
